...
"use strict";
var Html = _require.Html, Head = _require.Head, Body = _require.Body, Container = _require.Container, Heading = _require.Heading, Text = _require.Text;
var MyEmailComponent = function MyEmailComponent(_ref) {
    var name = _ref.name;
    return /*#__PURE__*/ React.createElement(Html, null, 
    ...
    /*#__PURE__*/ React.createElement(Text, null, "This is a test email using @react-email and Express."))));
};
